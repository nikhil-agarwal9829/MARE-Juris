  ...
  return (
    <div className="min-h-screen bg-navy-950 flex flex-col justify-between selection:bg-gold-500 selection:text-navy-950">
      ...
      <main className="pt-24 pb-12 px-4 flex-1 flex items-center justify-center">
        <div className="max-w-md w-full legal-card rounded-3xl p-8 md:p-10 border border-gold-500/20 shadow-2xl">
          {/* Logo Header */}
          ...
          {submitted ? (
            <div className="text-center py-6 animate-fade-in space-y-4">
              ...
              <h2 className="text-2xl font-bold text-slate-100 font-serif">Check your email</h2>
              <p className="text-sm text-slate-300 leading-relaxed">
                Your verification link has been sent to{' '}
                <strong className="text-gold-300">{email}</strong>.
              </p>
              <p className="text-xs text-slate-400 bg-navy-900/60 p-3 rounded-xl border border-slate-800">
            ...
            <div>
              <div className="mb-6">
                <h1 className="text-2xl font-bold text-slate-100 font-serif">Create Account</h1>
